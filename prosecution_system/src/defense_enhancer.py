...
class DefenseEnhancer:
        ...
        for defense_type, patterns in self.DEFENSE_PATTERNS.items():
            ...
            for pattern, description in patterns:
                if re.search(pattern, facts_full):
                    ...
                    # 根据 defense_type + description 生成结构化证据点
                    ep = self._make_evidence_point(defense_type, description)
                    if ep and ep not in evidence_points:
    ...
    def _make_evidence_point(self, defense_type: DefenseType, description: str) -> Optional[str]:
        ...
        ep_map = {
            ...
            DefenseType.COMPENSATION: {
                "退赃退赔": "被告人已退还赃款并积极赔偿被害人损失",
                "退赃": "被告人已退还全部或部分赃款赃物",
                "赔偿被害人": "被告人已向被害人进行经济赔偿",
                "获得谅解": "被告人已取得被害人谅解",
                "赔偿协议": "被告人已与被害人达成赔偿协议",
            },
            DefenseType.COOPERATION: {
                "认罪认罚": "被告人自愿如实供述罪行并同意量刑建议",
                "认罪": "被告人认罪认罚",
                "坦白": "被告人如实供述犯罪事实",
            },
            DefenseType.EVIDENCE_INSUFFICIENT: {
            ...
            DefenseType.LEGITIMATE_DEFENSE: {
                "防卫行为": "被告人行为具有防卫性质",
                "自卫行为": "被告人行为属于自卫",
                "遭受不法侵害": "被告人遭受正在进行的不法侵害",
                "保护人身权利": "被告人为了保护人身权利采取行为",
                "制止正在进行的不法侵害": "被告人制止了正在进行的不法侵害",
            },
            DefenseType.EMERGENCY_ESCAPE: {
                "紧急避险": "被告人行为属于紧急避险",
                "迫不得已的行为": "被告人行为迫不得已",
            ...
            DefenseType.MERITOUS_REPORTING: {
                "立功": "被告人揭发他人犯罪或提供重要线索",
                "揭发犯罪": "被告人揭发了他人犯罪行为",
                "协助抓捕": "被告人协助司法机关抓捕其他犯罪嫌疑人",
            },
        }
        type_map = ep_map.get(defense_type, {})
        return type_map.get(description)
